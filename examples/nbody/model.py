...
class NBodyPipeline(pl.LightningModule):
    ...
    def training_step(self, batch: torch.Tensor):
        ...
        edges = get_edges(batch_size, n_nodes) # returns a list of two tensors, each of size num_edges * batch_size (where num_edges is always 20, since G = K5)
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.Adam([
                {'params': self.prediction_network.parameters(), 'lr': self.learning_rate},
