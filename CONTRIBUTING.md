...
If you experience bugs or general issues with `equiadapt`, please have a look
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/equiadapt.git
   cd equiadapt
   ```
...
5. Install [pre-commit]:
   ...
   `equiadapt` comes with a lot of hooks configured to automatically help the
