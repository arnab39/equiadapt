...
class ImageSegmentationPipeline(pl.LightningModule):
    def __init__(self, hyperparams: DictConfig):
        ...
        self.prediction_network = get_prediction_network(
            predition_network_hyperparams=hyperparams.prediction,
    ...
    def apply_loss(self, pred_mask: torch.Tensor, gt_mask: torch.Tensor, num_masks: int):
        if self.loss is not None:
            pass
        
        raise NotImplementedError("apply_loss method must be implemented")
    ...
    def training_step(self, batch: torch.Tensor):
        ...
        loss = self.apply_loss(logits, y) # TODO: implement this method
